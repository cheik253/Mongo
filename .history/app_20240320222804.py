...
def count():
    try:
        ...
        chart_data = [
            {"name": "Number of Voters", "data": numbers_of_elements}
        ]
        categories = voter_name  # Assuming 'name' field represents categories

        # Return the data as JSON
        return jsonify(chartData=chart_data, categories=categories)

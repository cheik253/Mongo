...
$(function() {
    // AJAX request to your Flask endpoint for the vote counts
    $.ajax({
        url: "/election",
        type: "GET",
        success: function(response) {
            // Extract vote count data from the response
            var voteCount = response.vote;
            var notVoteCount = response.not_vote;
            ...
            var options = {
                ...
                series: [voteCount, notVoteCount], // Series data for pie chart
                labels: ['Voted', 'Not Voted'], // Labels for pie chart
                legend: {
                    show: true,
                    position: 'right',
            ...
            // Initialize and render the pie chart within the existing div

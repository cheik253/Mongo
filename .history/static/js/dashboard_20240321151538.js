...
$(function() {
    ...
    $.ajax({
        url: "/can_age",  // Modify the URL to match your Flask route for the new chart data
        type: "GET",
        success: function(response) {
            var categories = response.categories;
            var series = response.chartData[0].data;
            ...
            var options = {
                chart: {
                    type: 'char', // Assuming "char" is a valid chart type
                    height: 400,
                },
                series: series,
                labels: categories,
            ...
            var chart = new ApexCharts(document.querySelector("#new_chart_div"), options); // Render within a new div with id "new_chart_div"
            chart.render();
        },
        error: function(error) {

...
def voting(candidate, voter):
    ...
    if candidate_doc:
        a='<div class="alert alert-warning alert-dismissible fade show" role="alert"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">you have a</button></div>'

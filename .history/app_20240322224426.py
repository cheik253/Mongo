from flask import Flask, render_template, redirect, url_for, request, flash, session,jsonfi
...
app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(seconds=40)  # Adjust the time as needed
...
def dashboard():
    if 'user' in session:  # Check if user is logged in
        ...
        i = session['user']
        session_timeout_seconds = 40  # Directly using the session timeout value
